	...
	return (
		<div className='max-w-screen-xl container mx-auto px-4 sm:px-6 lg:px-8 py-8 flex flex-col gap-5'>
			<form className="max-w-sm w-full mx-auto">
				...
				<button onClick={currentProductId ? updateProduct : addNewProduct} className="text-white bg-gray-500 hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">{currentProductId ? 'Save' : 'Add new product'}</button>
			</form>
